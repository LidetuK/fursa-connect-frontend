          ...
          <form className="space-y-6" onSubmit={handleLogin}>
            <div>
              ...
              <input
                ...
                className="appearance-none block w-full px-4 py-3 border border-gray-200 rounded-xl shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#FB8A32] focus:border-transparent transition-all duration-200 bg-white/50"
            ...
            <div>
              <Button
                type="submit"
                className="w-full bg-gradient-to-r from-[#FB8A32] to-[#E67A2A] hover:from-[#E67A2A] hover:to-[#D16A1A] text-white font-semibold py-3 px-4 rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 transform hover:scale-[1.02]"
                disabled={loading}
              >
                {loading ? (
