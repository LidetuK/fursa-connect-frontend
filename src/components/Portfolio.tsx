              ...
              <button
                ...
                className={`px-4 py-2 rounded-full text-sm font-medium transition-all ${
                  activeCategory === category
                    ...
                    : 'bg-slate-800 hover:bg-orange-500/10 text-gray-300 border border-slate-700'
                }`}
              >
                {category}
              </button>
          ...
          {filteredProjects.map((project) => (
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-6">
                <span className="text-xs font-medium text-orange-400 bg-slate-800/90 rounded-full py-1 px-3 mb-3 self-start">
                  {project.category}
                </span>
                ...
                <a 
                  href={project.link} 
                  className="flex items-center gap-2 text-white font-medium text-sm hover:text-orange-400 transition-colors"
                >
