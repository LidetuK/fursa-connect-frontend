...
const UserProfile = () => {
  ...
  const fetchUserProfile = async () => {
    setLoading(true);
    try {
      // Use the NestJS backend instead of Supabase
      const response = await fetch('https://fursaconnet-production.up.railway.app/auth/me', {
        method: 'GET',
        credentials: 'include',
      });
  ...
  const handleProfileUpdate = async () => {
    ...
    try {
      // Use the NestJS backend instead of Supabase
      const response = await fetch('https://fursaconnet-production.up.railway.app/auth/update-profile', {
        method: 'POST',
        headers: {
  ...
  const handlePasswordChange = async () => {
    ...
    try {
      // Use the NestJS backend instead of Supabase
      const response = await fetch('https://fursaconnet-production.up.railway.app/auth/update-password', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
