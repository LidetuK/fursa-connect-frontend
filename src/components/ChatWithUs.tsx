...
const ChatWithUs = () => {
  ...
  return (
    <section id="chat" className="py-20 bg-slate-800 relative overflow-hidden">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-3xl mx-auto bg-slate-900 rounded-lg shadow-xl overflow-hidden border border-slate-700">
          {/* Chat header */}
          ...
          >
            ...
            {isLoading && (
              <div className="flex justify-start">
                <div className="bg-slate-700 text-gray-200 rounded-lg rounded-tl-none max-w-[80%] p-3">
      ...
      <div className="absolute -top-24 -left-24 w-64 h-64 bg-orange-500/5 rounded-full"></div>
      <div className="absolute -bottom-32 -right-32 w-96 h-96 bg-orange-600/5 rounded-full"></div>
    </section>
  );
};
