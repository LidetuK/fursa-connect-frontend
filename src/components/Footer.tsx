        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-300 mb-4">
              Your one-stop destination for professional web development and comprehensive digital marketing solutions.
            </p>
            <div className="flex space-x-4">
              <a href="https://facebook.com" className="text-gray-400 hover:text-orange-400 transition-colors">
                <span className="sr-only">Facebook</span>
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd" />
                </svg>
              </a>
              <a href="https://instagram.com" className="text-gray-400 hover:text-orange-400 transition-colors">
              ...
              <a href="https://twitter.com" className="text-gray-400 hover:text-orange-400 transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/#web-development" className="text-gray-300 hover:text-orange-400 transition-colors">Web Development</Link></li>
              <li><Link to="/#digital-marketing" className="text-gray-300 hover:text-orange-400 transition-colors">Digital Marketing</Link></li>
              <li><Link to="/#content-creation" className="text-gray-300 hover:text-orange-400 transition-colors">Content Creation</Link></li>
              <li><Link to="/#seo-services" className="text-gray-300 hover:text-orange-400 transition-colors">SEO Services</Link></li>
              <li><Link to="/#social-media" className="text-gray-300 hover:text-orange-400 transition-colors">Social Media Management</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/#team" className="text-gray-300 hover:text-orange-400 transition-colors">Our Team</Link></li>
