...
const TeamMember = ({ name, role, bio, imageUrl, socialLinks }: TeamMemberProps) => {
  return (
    <Card className="overflow-hidden hover:shadow-lg transition-shadow duration-300 bg-slate-800 border border-slate-700">
      <div className="aspect-square overflow-hidden bg-slate-700">
        <Avatar className="h-full w-full rounded-none">
          ...
          <AvatarFallback className="text-xl font-semibold h-full w-full rounded-none bg-slate-700 text-white">
      ...
      <CardContent className="p-5">
        ...
        <p className="text-orange-400 font-medium mb-3">{role}</p>
